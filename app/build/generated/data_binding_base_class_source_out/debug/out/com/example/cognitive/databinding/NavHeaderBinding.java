...
public final class NavHeaderBinding implements ViewBinding {
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.userNameNav;
      TextView userNameNav = ViewBindings.findChildViewById(rootView, id);
      if (userNameNav == null) {
        break missingId;
      }

      return new NavHeaderBinding((LinearLayout) rootView, headerImage, userNameNav);
    }
