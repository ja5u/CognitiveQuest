...
public final class CustomPopupBinding implements ViewBinding {
  ...
  private CustomPopupBinding(@NonNull ConstraintLayout rootView, @NonNull TextView popUpText) {
  ...
  public static CustomPopupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomPopupBinding((ConstraintLayout) rootView, popUpText);
    }
