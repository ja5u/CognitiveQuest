...
public final class FragmentSignInBinding implements ViewBinding {
  ...
  private FragmentSignInBinding(@NonNull LinearLayout rootView, @NonNull Button signupButton,
  ...
  public static FragmentSignInBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSignInBinding((LinearLayout) rootView, signupButton, signupConfirm,
